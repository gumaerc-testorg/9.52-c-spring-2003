...
The readings listed below are the foundation of this course. Where available, journal article abstracts from {{% resource_link "39512b65-5f64-437b-bfa2-ced9bfe2f8f7" "PubMed" %}} (an online database providing access to citations from biomedical literature) are included.

Ahn, W. K., Kalish, C., Gelman, S. A., Medin, D. L., Luhmann, C., Atran, S., Coley, J. D., Shafto, P. (2001). "{{% resource_link "66ebc690-4ba2-4f38-a050-1b2174b81fef" "Why Essences are Essential in the Psychology of Concepts" %}}." _Cognition_ 82, 59-69.
...
Atran, S. (1998). "{{% resource_link "7ca55d30-1313-4bfe-994a-e8df5c639607" "Folk Biology and the Anthropology of Science: Cognitive Universals and Cultural Particulars" %}}." _Behavioral and Brain Sciences_ 21: 547-569, Cambridge University Press.
...
Glymour, C. (2003). "{{% resource_link "3322d8f4-a1fa-4eb8-a19a-6e6c47732fc2" "Learning, Prediction and Causal Bayes Nets" %}}." _Trends in Cognitive Science_ 7, 43-48.
...
Keil, F. C. (2003). "{{% resource_link "39cb9af8-9197-465b-b050-cdc9e9ab1bcb" "Folkscience: Coarse Interpretations of a Complex Reality" %}}." _Trends in Cognitive Sciences_ 7, 368-373.
...
Margolis, E. and Laurence, S. (2002). "{{% resource_link "d961eb45-b126-41e7-be3a-02d60274dc2f" "Radical Concept Nativism" %}}." _Cognition_ 86, 22-55.
...
McClelland, J. L. and Rogers, T. T. (2003). "{{% resource_link "590e883a-16f7-45a4-92d4-e45a76a2ea42" "The Parallel Distributed Processing Approach to Semantic Cognition" %}}." _Nature Reviews Neuroscience_ 4, 310-322.
...
Smith, E. E., Shafir, E., and Osherson, D. (1993). "{{% resource_link "7ae30720-7481-4268-8840-95ea5e8ae92b" "Similarity, Plausibility, and Judgments of Probability" %}}." _Cognition_ 49, 2, 67-96.
...
Strevens, M. (2000). "{{% resource_link "51168d9f-a847-4460-8803-c9debab85f40" "The Essentialist Aspect of Naive Theories" %}}." _Cognition_ 74, 149-175.
...
Tenenbaum, J. B., and Griffiths, T. L. (2001). "{{% resource_link "437e3bb5-34fa-4fb9-9a8d-bd8b19891ce9" "Generalization, Similarity, and Bayesian Inference" %}}." _Behavioral and Brain Sciences_ 24, 629-641.
...
Wellman, H. M., and Gelman, S. A. (1992). "{{% resource_link "944be4c8-89ae-4def-ab05-67634875c166" "Cognitive Development: Foundational Theories of Core Domains" %}}." _Annual Review of Psychology_ 43, 337-75.